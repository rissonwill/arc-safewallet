...
## Correção MetaMask Desktop e Backtest (v36)
- [ ] Corrigir conexão MetaMask no desktop
- [ ] Testar conexão MetaMask no navegador
- [ ] Backtest: criar projeto
- [ ] Backtest: criar contrato
- [ ] Backtest: compilar contrato
- [ ] Backtest: fazer deploy
...
## Correção SmartVault Network → Arc Network (v37)
- [x] Buscar todas as referências de "SmartVault Network" no projeto
- [x] Substituir por "Arc Network" em todos os arquivos (12 ocorrências em 5 arquivos)
