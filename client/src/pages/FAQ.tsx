...
export default function FAQ() {
  ...
  const faqs: FAQItem[] = language === "pt" ? [
    ...
    // Redes
    {
      ...
      answer: "Suportamos Arc Network Testnet, Ethereum Mainnet, Sepolia Testnet, Polygon, BSC, Arbitrum, Optimism, Base e Avalanche. Novas redes são adicionadas regularmente."
    },
    {
      category: "network",
      question: "O que é a Arc Network?",
      answer: "Arc Network é uma blockchain Layer 2 focada em finalidade determinística sub-segundo e baixas taxas. Usa USDC como token de gas, facilitando a previsibilidade de custos para desenvolvedores."
    },
    {
      category: "network",
    ...
    {
      category: "network",
      question: "Qual é o gas fee na Arc Network?",
      answer: "A Arc Network usa um gas price mínimo de 160 Gwei com USDC como token de gas. Isso resulta em taxas previsíveis e estáveis, diferente de redes que usam tokens voláteis."
    },
  ] : [
    // Wallet
    {
    ...
    // Networks
    {
      ...
      answer: "We support Arc Network Testnet, Ethereum Mainnet, Sepolia Testnet, Polygon, BSC, Arbitrum, Optimism, Base, and Avalanche. New networks are added regularly."
    },
    {
      category: "network",
      question: "What is Arc Network?",
      answer: "Arc Network is a Layer 2 blockchain focused on sub-second deterministic finality and low fees. It uses USDC as the gas token, making cost predictability easier for developers."
    },
    {
      category: "network",
    ...
    {
      category: "network",
      question: "What is the gas fee on Arc Network?",
      answer: "Arc Network uses a minimum gas price of 160 Gwei with USDC as the gas token. This results in predictable and stable fees, unlike networks that use volatile tokens."
    },
  ];
      ...
      <section className="py-16 bg-gradient-to-b from-purple-900/20 to-background">
        <div className="container text-center">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            {language === "pt" 
              ? "Encontre respostas para as dúvidas mais comuns sobre a plataforma Arc SafeWallet."
              : "Find answers to the most common questions about the Arc SafeWallet platform."}
          </p>
        </div>
      </section>
