...
const WALLET_TYPES = [
  ...
  { id: "arc", name: "SmartVault Network", icon: "⚡" },
...
export default function Wallets() {
  ...
  const handleSwitchToArc = async () => {
    try {
      ...
      const state = WalletAPI.getWalletState();
      setWalletState(state);
      toast.success("Conectado à SmartVault Network Testnet!");
    } catch (error: any) {
        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          <div>
            ...
            <p className="text-muted-foreground text-sm mt-1">
              Gerencie suas carteiras e transações na SmartVault Network e Sepolia
            </p>
          </div>
            ...
            <Card className="border-primary/30 bg-primary/5">
              <CardContent className="p-4">
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <div>
                    <h3 className="font-semibold">SmartVault Network Testnet</h3>
